...
class GoogleSearch:
    ...
    def search(self, query, max_general_results, max_video_results, include_videos=False):
        results = []
        ...
        if include_videos:
            video_results = self._make_search_call(f"{query} site:youtube.com", max_video_results)
